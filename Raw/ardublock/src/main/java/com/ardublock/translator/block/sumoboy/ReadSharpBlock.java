...
public class ReadSharpBlock extends TranslatorBlock
{
    
    public ReadSharpBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		String ret ="sumoboy.sharp.read("+type+")";
