...
public class DriveForward extends TranslatorBlock
{
    
    public DriveForward(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		String ret = "sumoboy.motor.run( 0,0," + left + ");\n";
                ret += "sumoboy.motor.run( 1,0," + right + ");\n";
		return  ret;			
	}
