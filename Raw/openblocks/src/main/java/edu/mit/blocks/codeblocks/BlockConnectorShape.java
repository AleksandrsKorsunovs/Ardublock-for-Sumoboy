...
//    
//    /** width of command input bar */
//    public static final float CASE_INPUT_BAR_WIDTH = BlockShape.COMMAND_PORT_OFFSET + 20f;
//
//    /** height of command input bar */
//    public static final float CASE_INPUT_BAR_HEIGHT = 5f;
//
//    /** default height of command input */
//    public static final float CASE_COMMAND_INPUT_HEIGHT = DATA_PLUG_HEIGHT;
    ...
    private void addDebugConnectionShapeMappings() {
        ...
        addConnenctionShapeMapping("case", 15);
    }
...
//    public Point2D addCaseSocket(GeneralPath blockPath, int commandSocketHeight) 
//    {
//
//        //draw bar
//        BlockShapeUtil.lineToRelative(blockPath, CASE_INPUT_BAR_WIDTH, 0);
//        BlockShapeUtil.lineToRelative(blockPath, 0, CASE_INPUT_BAR_HEIGHT);
//        Point2D socketPoint = addControlConnectorShape(blockPath, false);
//
//        //first corner inside command input
//        BlockShapeUtil.cornerTo(blockPath,
//                new Point2D.Float(
//                (float) blockPath.getCurrentPoint().getX() - CASE_INPUT_BAR_WIDTH + BlockShape.CORNER_RADIUS_CASE,
//                (float) blockPath.getCurrentPoint().getY()),
//                new Point2D.Float(
//                (float) blockPath.getCurrentPoint().getX() - CASE_INPUT_BAR_WIDTH + BlockShape.CORNER_RADIUS_CASE,
//                (float) blockPath.getCurrentPoint().getY() + BlockShape.CORNER_RADIUS_CASE),
//                BlockShape.CORNER_RADIUS_CASE);
//
//
//
//        //insert dynamic command input height between these two methods
...
//                (float) blockPath.getCurrentPoint().getY() + BlockShape.CORNER_RADIUS_CASE),
//                new Point2D.Float(
//                (float) blockPath.getCurrentPoint().getX() + BlockShape.CORNER_RADIUS_CASE,
//                (float) blockPath.getCurrentPoint().getY() + BlockShape.CORNER_RADIUS_CASE),
//                BlockShape.CORNER_RADIUS_CASE);
//
//
...
//    static public boolean isCaseConnector(BlockConnector connector) {
//        return ( BlockConnectorShape.getConnenctionShapeMapping(connector.getKind()) == BlockConnectorShape.CASE);
//    }
