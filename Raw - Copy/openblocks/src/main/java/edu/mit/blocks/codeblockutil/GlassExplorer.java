...
public class GlassExplorer extends JPanel implements Explorer, FocusListener {
    ...
    public void reformView() {
        ...
        if (this.getHeight() < this.drawers.size() * 25) {
            ...
            retardedPane.setPreferredSize(new Dimension(0, this.getHeight() - this.drawers.size() * (int)(25*1)));
        }
    }
    
    public void resizeView(double multiplier)
    {
        retardedPane.setPreferredSize(new Dimension(0,(int) (this.getHeight() - this.drawers.size() * 25 * multiplier)));
       // canvasPane.paint
    }
