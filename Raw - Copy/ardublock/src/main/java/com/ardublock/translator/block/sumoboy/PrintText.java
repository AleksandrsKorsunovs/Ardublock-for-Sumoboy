...
public class PrintText extends TranslatorBlock
{
    
    public PrintText(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
